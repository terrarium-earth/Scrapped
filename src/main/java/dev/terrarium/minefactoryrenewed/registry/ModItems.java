...
import dev.terrarium.minefactoryrenewed.item.*;
import dev.terrarium.minefactoryrenewed.item.syringe.*;
...
public class ModItems {
    ...
    //Rubber Items
    public static final RegistryObject<Item> RAW_RUBBER = ITEMS.register("raw_rubber", BaseItem::new);
    public static final RegistryObject<Item> RUBBER = ITEMS.register("rubber", BaseItem::new);
    public static final RegistryObject<Item> RAW_PLASTIC = ITEMS.register("raw_plastic", BaseItem::new);
    public static final RegistryObject<Item> PLASTIC_SHEETS = ITEMS.register("plastic_sheets", BaseItem::new);
    ...
    public static final RegistryObject<Item> INDUSTRIAL_FERTILIZER = ITEMS.register("industrial_fertilizer", BaseItem::new);
    ...
    public static final RegistryObject<Item> PINK_SLIME_BALL = ITEMS.register("pink_slime_ball", BaseItem::new);
    public static final RegistryObject<Item> PINK_SLIME_CRYSTAL = ITEMS.register("pink_slime_crystal", BaseItem::new);
    ...
    //Syringes
    public static final RegistryObject<Item> EMPTY_SYRINGE = ITEMS.register("empty_syringe", () -> new Item(SINGLE_STACK));
    public static final RegistryObject<Item> DE_ZOMBIFICATION_SYRINGE = ITEMS.register("de_zombification_syringe", DeZombieSyringe::new);
    public static final RegistryObject<Item> SLIME_EMBIGGENING_SYRINGE = ITEMS.register("slime_embiggening_syringe", SlimeSyringe::new);
    ...
    //Laser Focus
    public static final RegistryObject<Item> WHITE_FOCUS = ITEMS.register("white_focus", () -> new FocusItem(ModTags.WHITE_FOCUS, DyeColor.WHITE));
    public static final RegistryObject<Item> YELLOW_FOCUS = ITEMS.register("yellow_focus", () -> new FocusItem(ModTags.YELLOW_FOCUS, DyeColor.YELLOW));
    public static final RegistryObject<Item> BLACK_FOCUS = ITEMS.register("black_focus", () -> new FocusItem(ModTags.BLACK_FOCUS, DyeColor.BLACK));
    public static final RegistryObject<Item> BLUE_FOCUS = ITEMS.register("blue_focus", () -> new FocusItem(ModTags.BLUE_FOCUS, DyeColor.BLUE));
    public static final RegistryObject<Item> BROWN_FOCUS = ITEMS.register("brown_focus", () -> new FocusItem(ModTags.BROWN_FOCUS, DyeColor.BROWN));
    public static final RegistryObject<Item> CYAN_FOCUS = ITEMS.register("cyan_focus", () -> new FocusItem(ModTags.CYAN_FOCUS, DyeColor.CYAN));
    public static final RegistryObject<Item> GRAY_FOCUS = ITEMS.register("gray_focus", () -> new FocusItem(ModTags.GRAY_FOCUS, DyeColor.GRAY));
    public static final RegistryObject<Item> GREEN_FOCUS = ITEMS.register("green_focus", () -> new FocusItem(ModTags.GREEN_FOCUS, DyeColor.GREEN));
    public static final RegistryObject<Item> LIGHT_BLUE_FOCUS = ITEMS.register("light_blue_focus", () -> new FocusItem(ModTags.LIGHT_BLUE_FOCUS, DyeColor.LIGHT_BLUE));
    public static final RegistryObject<Item> LIGHT_GRAY_FOCUS = ITEMS.register("light_gray_focus", () -> new FocusItem(ModTags.LIGHT_GRAY_FOCUS, DyeColor.LIGHT_GRAY));
    public static final RegistryObject<Item> LIME_FOCUS = ITEMS.register("lime_focus", () -> new FocusItem(ModTags.LIME_FOCUS, DyeColor.LIME));
    public static final RegistryObject<Item> MAGENTA_FOCUS = ITEMS.register("magenta_focus", () -> new FocusItem(ModTags.MAGENTA_FOCUS, DyeColor.MAGENTA));
    public static final RegistryObject<Item> ORANGE_FOCUS = ITEMS.register("orange_focus", () -> new FocusItem(ModTags.ORANGE_FOCUS, DyeColor.ORANGE));
    public static final RegistryObject<Item> PINK_FOCUS = ITEMS.register("pink_focus", () -> new FocusItem(ModTags.PINK_FOCUS, DyeColor.PINK));
    public static final RegistryObject<Item> PURPLE_FOCUS = ITEMS.register("purple_focus", () -> new FocusItem(ModTags.PURPLE_FOCUS, DyeColor.PURPLE));
    public static final RegistryObject<Item> RED_FOCUS = ITEMS.register("red_focus", () -> new FocusItem(ModTags.RED_FOCUS, DyeColor.RED));
}
