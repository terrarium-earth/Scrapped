...
import dev.terrarium.minefactoryrenewed.blockentity.container.machine.processing.WeatherContainer;
...
public class WeatherScreen extends MachineScreen<WeatherContainer> {

    private static final ResourceLocation WEATHER_GUI = new ResourceLocation(MinefactoryRenewed.MODID, "textures/gui/weather_gui.png");

    public WeatherScreen(WeatherContainer menu, Inventory inventory, Component title) {
        super(menu, inventory, title, WEATHER_GUI, false);
    }
