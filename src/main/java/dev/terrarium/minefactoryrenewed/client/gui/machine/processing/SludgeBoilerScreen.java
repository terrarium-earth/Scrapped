...
import dev.terrarium.minefactoryrenewed.blockentity.container.machine.processing.SludgeBoilerContainer;
...
public class SludgeBoilerScreen extends MachineScreen<SludgeBoilerContainer> {

    private static final ResourceLocation SLUDGE_BOILER_GUI = new ResourceLocation(MinefactoryRenewed.MODID, "textures/gui/sludge_boiler_gui.png");

    public SludgeBoilerScreen(SludgeBoilerContainer menu, Inventory inventory, Component title) {
        super(menu, inventory, title, SLUDGE_BOILER_GUI, false);
    }
