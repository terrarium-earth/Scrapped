...
import dev.terrarium.minefactoryrenewed.blockentity.container.machine.farming.FertilizerContainer;
...
public class FertilizerScreen extends MachineScreen<FertilizerContainer> {

    private static final ResourceLocation FERTILIZER_GUI = new ResourceLocation(MinefactoryRenewed.MODID, "textures/gui/fertilizer_gui.png");

    public FertilizerScreen(FertilizerContainer menu, Inventory inventory, Component title) {
        super(menu, inventory, title, FERTILIZER_GUI);
    }
